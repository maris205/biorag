...
python figures/gen_fig7_seq_lit_dag.py
...
| Fig. 7 SeqLit-DAG | `fig7_seq_lit_dag.pdf` | `gen_fig7_seq_lit_dag.py` | `data/seq_lit_dag_swissprot_2k/manifest.json` |
...
- Fig. 7 is a compact application schematic backed by the CPU-built 2k
  BioRAG-SeqLit-DAG manifest. It shows the typed sequence-to-literature evidence
  view and the citation/abstention Agent boundary rather than claiming that the
  full heterogeneous biology graph is acyclic.
