...
\begin{enumerate}
  ...
  \item \textbf{A sequence-to-literature Agent application.} We release a typed protein-to-GO/GOA-to-PubMed DAG view, add observed-UniRef50 and identity-30 cluster-held-out controls, evaluate a development/test-frozen evidence selector and local instruction model, and retain biological graph analysis as an explicitly exploratory result bounded by parent-collapse, k-mer, and degree-preserving null controls.
\end{enumerate}
